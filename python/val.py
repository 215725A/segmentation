...
def main(config_path):
  ...
  for mod in models:
    output_path_1 = f'../videos/{output_dir}/{os.path.splitext(os.path.basename(mod))[0]}/result.mp4'
    output_path_2 = f'../videos/{output_dir}/{os.path.splitext(os.path.basename(mod))[0]}/result_colormap.mp4'
